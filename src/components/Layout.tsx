...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      >
        {/* Top Utilities Bar - hides on scroll */}
        <div className={`border-b border-gray-100 transition-all duration-300 overflow-hidden ${
            ...
            <div className="flex items-center justify-between h-14">
              ...
              <Link to="/" className="absolute left-1/2 transform -translate-x-1/2 flex flex-col items-center">
                <div className="flex items-center gap-3">
                  <span className="hidden sm:block w-8 h-px bg-gray-300" />
                  <div className="text-center">
                    <span className="text-xl md:text-2xl font-light tracking-[0.3em] text-gray-900">
                      SPARKLE
                    </span>
                    <p className="text-[10px] tracking-[0.25em] text-gray-400 uppercase -mt-0.5">
                      Handmade
                    </p>
                  </div>
                  <span className="hidden sm:block w-8 h-px bg-gray-300" />
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid md:grid-cols-12 gap-8">
            ...
            <div className="md:col-span-5">
              <div className="mb-6">
                <span className="text-xl font-light tracking-[0.2em] text-gray-900">SPARKLE</span>
                <p className="text-[10px] tracking-[0.2em] text-gray-400 uppercase">Handmade</p>
              </div>
            ...
            <div className="md:col-span-3">
              <h4 className="text-xs font-medium tracking-[0.15em] uppercase text-gray-900 mb-4">
            ...
            <div className="md:col-span-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center text-sm text-gray-900 hover:text-dark-green transition-colors"
              >
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-xs text-gray-400 flex items-center gap-1">
              ...
              {' '}{language === 'mk' ? 'во Македонија' : 'in Macedonia'}
            </p>
          </div>
        </div>
      </footer>
